...
public class ShootCenterTele extends CommandBase {
  private final FlyWheelSubsystem flyWheelSubsystem;
  private final TurretSubsystem turretSubsystem;
  /**
   * Creates a new ShootCenterTele.
   */
  public ShootCenterTele(FlyWheelSubsystem subsystem, TurretSubsystem subsystem2) {
