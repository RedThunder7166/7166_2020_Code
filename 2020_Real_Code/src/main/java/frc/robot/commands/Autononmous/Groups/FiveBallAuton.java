...
public class FiveBallAuton extends ParallelCommandGroup {
   ...
   */
  public FiveBallAuton(DriveSubsystem driveSubsystem, TurretSubsystem turretSubsystem, ConveyorSubsystem conveyorSubsystem, FlyWheelSubsystem flywheelSubsystem, ArmSubsystem armSubsystem) {
    // Add your commands in the super() call, e.g.
    addCommands(new AutoArmUp(armSubsystem) ,new AutoIntake(conveyorSubsystem, armSubsystem, 50),
                new FiveBallMoves(driveSubsystem, turretSubsystem, conveyorSubsystem, flywheelSubsystem, armSubsystem)
    );
  }
}
